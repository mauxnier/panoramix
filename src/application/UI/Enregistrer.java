...
public class Enregistrer extends Stage implements Initializable{
	...
	public Enregistrer() {
		try {
			...
			final URL fxmlURL = getClass().getResource("enregistrer.fxml"); 
		    ...
		    this.setTitle("Panoramix - Enregistrer");
    ...
    public void initialize(URL location, ResourceBundle resources) {
		...
		bnSave.setOnAction(e-> {
			application.Main.saveListes(textNom.getText() + ".pano");
			close();
		});
	}
}
